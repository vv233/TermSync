...
- [x] High-speed SFTP pipeline (async read, nonblocking I/O pump, packet/window tuning, benchmark target)  → M18  *(5 GB measured vs real OpenSSH: up 347 / down 250 MiB/s, both over the 150 target)*
